...
const Resume_Oishy = () => {
  return (
    <div>
      <h2>Visual representation of the Resume</h2>
        ...
        <div className="section">
          ...
          <ul className="projects">
            <li>
              ...
              <ul>
                <li>A web platform facilitating connections between blood donors and recipients, enabling users to browse and register for blood donation opportunities. Additionally, it features an admin panel for user management.</li>
                <li>Technologies Used: HTML, CSS, JavaScript, PHP, MySQL.</li>
                <li>Project Link: <a href="https://github.com/ShadmanSakib44/Plasma-Plus">GitHub</a></li>
              </ul>
            </li>
            <li>
              <h3>EduCast - Contributor</h3>
              <ul>
                <li>An innovative website for connecting educators and students with blog posting, tutoring, video conferencing, and messaging functionalities.</li>
                <li>Technologies Used: MERN Stack, Agile Methodologies, Jitsi Meet API for video conferencing functionality.</li>
                <li>Project Link: <a href="https://github.com/ShadmanSakib44/EduCast-">GitHub</a></li>
              </ul>
            </li>
            <li>
              <h3>ResuMetrics - Contributor</h3>
              <ul>
                <li>A job recruitment website with an integrated resume builder.</li>
                <li>Technologies Used: MERN Stack, Cloudinary for file handling.</li>
                <li>Project Link: <a href="https://github.com/ShadmanSakib44/ResuMetrics">GitHub</a></li>
              </ul>
            </li>
            <li>
              <h3>IUT_BARTA - Contributor</h3>
              <ul>
                <li>A social media website exclusively for IUTians.</li>
                <li>Technologies Used: PHP, MySQL, HTML, CSS, JavaScript.</li>
                <li>Project Link: <a href="https://github.com/ShadmanSakib44/IUT_BARTA">GitHub</a></li>
              </ul>
            </li>
            <li>
              <h3>Cyber_Memoirs - Developer</h3>
              <ul>
                <li>A server-based CTF writeup blogging platform.</li>
                <li>Technologies Used: HTML, CSS (Frontend), Node.js, MongoDB (Backend), Multer (for file handling).</li>
                <li>Project Link: <a href="https://github.com/oishy28/Cyber_Memoirs">GitHub</a></li>
              </ul>
            </li>
          </ul>
        </div>
